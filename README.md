...
After I finished the project, I did a presentation for the class. The slides are available [here](gallery/NXTPresentationGerman.pptx). A translated version (in English) is available [here](gallery/NXTPresentationEnglish.pptx).
